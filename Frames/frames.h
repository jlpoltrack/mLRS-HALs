...
uint16_t crc;
    ...
    frame->rc1.ch0  = rc->ch[0] / 2; // 10 bits
    frame->rc1.ch1  = rc->ch[1] / 2;
    frame->rc1.ch2  = rc->ch[2] / 2;
    frame->rc1.ch3  = rc->ch[3] / 2;

    frame->rc1.ch4  = rc->ch[4] / 32; // 6 bits
    frame->rc1.ch5  = rc->ch[5] / 32;
    frame->rc1.ch6  = rc->ch[6] / 32;
    frame->rc1.ch7  = rc->ch[7] / 32;

    frame->rc2.ch8  = rc->ch[8]  / 2; // 10 bits
    frame->rc2.ch9  = rc->ch[9]  / 2;
    frame->rc2.ch10 = rc->ch[10] / 2;
    frame->rc2.ch11 = rc->ch[11] / 2;

    frame->rc2.ch12 = rc->ch[12] / 32; // 6 bits
    frame->rc2.ch13 = rc->ch[13] / 32;
    frame->rc2.ch14 = rc->ch[14] / 32;
    frame->rc2.ch15 = rc->ch[15] / 32;
...
{
    rc->ch[0] = frame->rc1.ch0 * 2;
    rc->ch[1] = frame->rc1.ch1 * 2;
    rc->ch[2] = frame->rc1.ch2 * 2;
    rc->ch[3] = frame->rc1.ch3 * 2;

    rc->ch[4] = frame->rc1.ch4 * 32;
    rc->ch[5] = frame->rc1.ch5 * 32;
    rc->ch[6] = frame->rc1.ch6 * 32;
    rc->ch[7] = frame->rc1.ch7 * 32;
}
...
void rcdata_from_txframe(tRcData* rc, tTxFrame* frame)
{
    ...
    rc->ch[8]  = frame->rc2.ch8 * 2;
    rc->ch[9]  = frame->rc2.ch9 * 2;
    rc->ch[10] = frame->rc2.ch10 * 2;
    rc->ch[11] = frame->rc2.ch11 * 2;

    rc->ch[12] = frame->rc2.ch12 * 32;
    rc->ch[13] = frame->rc2.ch13 * 32;
    rc->ch[14] = frame->rc2.ch14 * 32;
    rc->ch[15] = frame->rc2.ch15 * 32;
